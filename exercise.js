...
const secondButtonElement = document.getElementById('adding-color');
...
// firstButtonElement.addEventListener('click',removingParagraph );
// secondButtonElement.addEventListener('click', addingBackgroundColor);
...
//    Note: You'll have to add those classes to the styles.css file first!e